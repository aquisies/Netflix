...
export default function Featured({ type }) {
	return (
		<div className="featured">
			...
			<img
				src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/matrix-4-working-title-project-ice-cream-1568020586.jpg"
				alt=""
			/>
			<div className="info">
				<img
				...
				<span className="desc">
					...
					eaque voluptatibus fugit, a quisquam sapiente culpa non est distinctio
					eius natus quos dolor consectetur. Molestias dignissimos voluptatibus
					repellat modi!
				</span>
